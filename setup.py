...
setup(
    name="nm_capstone_project",
    version="0.1.0",
    description=(
        "An ETL project for extracting, transforming, and loading data."),
    author="Negin Moghadam",
    author_email="negin.mgdm@gmail.com",
    url="https://github.com/negin-mgdm/df-capstone-project",
